...
const ItinerarySection: React.FC<ItinerarySectionProps> = ({ itinerary }) => {
  ...
  const currentDay = itinerary.find(day => day.day === activeDay) || itinerary[0];
      ...
      <div className="container-custom mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Explore your day-by-day journey through Namibia. Click on each day to see the detailed activities and experiences.
          </p>
        </div>
        ...
        >
          ...
          <div className="bg-gray-800 text-white p-6">
            <h3 className="text-2xl font-bold">Day {currentDay.day}: {currentDay.location}</h3>
            {currentDay.date && <p className="text-gray-300 mt-1">Date: {currentDay.date}</p>}
          </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">{currentDay.transportation || 'Not specified'}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">{currentDay.accommodation || 'Not included'}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600">
                        {currentDay.meals.breakfast && <p>Breakfast: {currentDay.meals.breakfast}</p>}
                        {currentDay.meals.lunch && <p>Lunch: {currentDay.meals.lunch}</p>}
                        {currentDay.meals.dinner && <p>Dinner: {currentDay.meals.dinner}</p>}
                        {!currentDay.meals.breakfast && !currentDay.meals.lunch && !currentDay.meals.dinner && <p>Meals not included</p>}
                      </div>
                    </div>
                  </div>
                </div>
